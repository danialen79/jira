...
function CalendarJalali({
  ...
  const resolvedLocale = locale ?? faIR
    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(resolvedLocale.code ?? "fa-IR", {
            month: "short",
          }),
        ...formatters,
      }}
      ...
      components={{
        ...
        DayButton: ({ ...props }) => (
          <CalendarJalaliDayButton locale={resolvedLocale} {...props} />
        ),
...
function CalendarJalaliDayButton({
  className,
  day,
  modifiers,
  locale,
...
export { CalendarJalali, CalendarJalaliDayButton }
